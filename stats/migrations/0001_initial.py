    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Ready', 'Ready'), ('InUse', 'Inuse'), ('Error', 'Error')], default='Ready', max_length=8)),
                ('last_status_at', models.DateTimeField(default=datetime.datetime(1970, 1, 1, 0, 0, tzinfo=utc))),
                ('last_error', models.TextField(blank=True, null=True)),
                ('last_commit_at', models.DateTimeField(default=datetime.datetime(1970, 1, 1, 0, 0, tzinfo=utc))),
            ],
            options={
        ...
        migrations.AddField(
            model_name='author',
            name='stats',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='stats.AuthorStat'),
        ),
    ]
